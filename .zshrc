...
ntfy_post() {
    curl -H "Authorization: Bearer tk_ukmfwmse2ui8tiezn0xh46q55tgxu" -d "$*" https://ntfy.wg.sumbot.uk/home
}
...
run_restic() {
    user="${SUDO_USER:-$USER}"
    source "/home/$user/.config/restic/resticenv"
    command sudo -E -- restic "$@"
}
